...
The international patent system as under the 1883 Paris Convention establishes a "priority" system it identify the earliest filing of an invention. In cases where an invention is filed by different applicants the priority number and date allows for the identification of the priority applicant. That is, the person or organisation that was the first to file for the claimed invention. 
