...
```
Back in 2015 I wrote a long blog post on [importing Excel tables into R](http://www.pauloldham.net/2015/04/30/reading-and-writing-an-excel-file-in-r/). Happily for everyone this is now a lot easier than it was. This post provides an update on importing spreadsheets into R and exporting from R to Excel. 
