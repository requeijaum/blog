---
title: Understanding Patent Databases
author: Paul Oldham
date: '2015-05-17'
slug: patent-databases-tutorial
categories:
  - Patents
tags: [patent databases]
---
```{r opts, echo=FALSE}
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/Lens_2015-0517_14-19-26.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/simplesearchresultspizza.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/pctseq.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/Espacenet.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/Espacenet_Latipat_2015-0517_15-11-21.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/OPS.png")
```

The developer portal allows you to test your API queries and is recommended. 

```{r echo=FALSE}
knitr::include_graphics("/images/tools/OPS_Developer_Portal.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/googlepatents_2015-0517_14-09-22.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/USPTObulk.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/USPTOGrant.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/Freepatentsonline2015-03-26\ 16-26-13.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/DEPATISnet_13-53-19.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/OECD_patent_databases.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/patstat.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/PIUG_Wiki_2015-0517_15-45-05.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/Intellogist_2015-0517_16-03-52.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/Patent2Net_GitHub_2015-0517_15-49-58.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/python-epo-ops-client-GitHub_2015-0517_15-53-34.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/funginstitutepatentserver.png")
```
