---
title: Visualising Data with Tableau Public
author: Paul Oldham
date: '2015-05-17'
slug: tableau-patents
categories:
  - Patents
tags: [tableau, patent analytics, dashboards]
---
```{r opts, echo=FALSE}
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/providemail.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/signup.png")
```

This will lead you to an empty profile page.

```{r echo=FALSE}
knitr::include_graphics("/images/tableau/profile.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/gallery.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/open.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/github.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/load_file.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/pizza1.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/tableau_fields.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/publication_trend.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/publication_trend_fill.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/sort_applicants.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/applicants_original.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/applicants_organisations.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/applicants_cleaned.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/edit_alias.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/add_data.png")
```

If all goes well the `Data` panel will now contain the following files. 

```{r echo=FALSE}
knitr::include_graphics("/images/tableau/data_panel.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/inventors_ranked.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/sheet_names.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/dashboard1.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/dashboard_fitwidth.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/save_public.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/profile_dashboard.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/profile_viewtabs3.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/profile_visibility.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tableau/profile_sharing.png")
```
