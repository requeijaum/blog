...
author: Paul Oldham
date: '2015-05-02'
slug: cleaning-patent-data
categories:
  - Patents
tags: [open refine, name cleaning]
---
```{r opts, echo=FALSE}
knitr::opts_chunk$set(warning = FALSE, message = FALSE, fig.align = "center", out.width = "800px")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/OpenRefine_front.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/create_project.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/create_project2.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/menu_basics.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/facet_menu.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/undo_redo.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/cleaning_pubno_createfacet.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/cleaning_pubno_totitlecase.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/title_trailingwhitespace.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/add_column_publicationyear.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/split_date.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/rename_column.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/replace_encoding.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/transform.png")
```

This produces a menu where we enter a simple GREL replace code. 

```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/transform_replace_date.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/publication_country.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/blank_na_facets.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/export_core.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/split_applicants_columns.png")
```

We then need to select the separator. In this case (and normally with patent data), it is `;`. 

```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/split_selectseparator.png")
```

This will produce a set of 18 columns.

```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/split_columns.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/split_multivaluedcells.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/split_multivaluedcells2.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/split_filldown.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/applicants_titlecase.png")
```

We now move back to the applicants and select `Facet > Text Facet`.

```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/applicants_textfacet.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/applicants1.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/cluster_step1.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/applicants2.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/applicants-ngramfingerprint2.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/ngram1_problems.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/applicants_metaphone3.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/applicants_browsecluster.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/applicants_browsecluster1.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/applicants_cologne.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/applicants_levenshtein.png")
```
