---
title: Exploring Scientific Literature with rplos
author: Paul Oldham
date: '2015-10-27'
slug: rplos-walkthrough
categories:
  - Patents
  - R
tags: [rplos, ropensci, plos api, scientometrics, bibliometrics, R]
---
```{r opts, echo=FALSE}
...
This produces 352 results at the time of writing. What happens now if we run our original query using the value of `r1` (352 records) but limiting the results only to PLOS ONE?
