---
title: Network Visualisation with Gephi
author: Paul Oldham
date: '2015-05-17'
slug: gephi_patent_network
categories:
  - Patents
tags: [gephi tutorial, network analysis, patent analytics, patent networks]
---
```{r opts, echo=FALSE}
...
This article focuses on visualising patent data in networks using the open source software [Gephi](http://gephi.github.io). 
...
This article is now a chapter in the WIPO Manual on Open Source Patent Analytics. You can read the chapter in electronic book format [here](https://wipo-analytics.github.io/gephi-1.html) and find all the materials including presentations at the [WIPO Analytics Github homepage](https://github.com/wipo-analytics).

```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/gephi_front.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/welcome.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/plugin.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/install.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/result.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/import.png")
```

You should now see a menu like that below. Make sure that you choose the co-occurrence option.

```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/wizard.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/select.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/figures_gephi/fig5_idelimiter.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/applicants.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/delimiter.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/dynamic.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/figures_gephi/fig8_options.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/create.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/warning.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/network.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/laboratory.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/edges.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/statistics.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/filter.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/size.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/colour.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/layout_settings.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/layout.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/noverlap.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/noverlap_laidout.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/labels.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/labels2.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/expanded.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/screenshot.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/rescale_weight.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/font3.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/final.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/zoom.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/export.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/gephi9/drones.png")
```
