---
title: An Overview of Patent Analytics Tools
author: Paul Oldham
date: '2015-07-26'
slug: overview-patent-analytics
categories:
  - Patents
tags: [patent databases, patent analytics, patent analytics software]
---
```{r opts, echo=FALSE}
...
This article provides an overview of the open source and free software tools that are available for patent analytics. The aim of the chapter is to serve as a quick reference guide for some of the main tools in the tool kit. 

This article is now a chapter in the [WIPO Manual on Open Source Patent Analytics](https://wipo-analytics.github.io/). You can read the chapter in electronic book format [here](https://wipo-analytics.github.io/an-overview-of-tools.html) and find all the materials including presentations at the [WIPO Analytics Github homepage](https://github.com/wipo-analytics).

We will go into some of the tools covered in his aticle in more depth elsewhere in the WIPO Manual on Open Source Patent Analytics and leave you to explore the rest of the tools for yourself. 
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/Fusion-Tables.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/Fusion-Tables-Cards.png")
```

```{r echo=FALSE}
knitr::include_graphics("/images/overview/Fusion-Tables-Map.png")
```
...
An in depth chapter is available [here](http://poldham.github.io/openrefine-patent-cleaning/) on the use of [Open Refine](http://openrefine.org), formerly Google Refine, for cleaning patent data. For patent analytics Open Refine is an important free tool for cleaning applicant and inventor names. 

```{r echo=FALSE}
knitr::include_graphics("/images/openrefine/OpenRefine-download.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/RapidMiner.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/KNIME.png")
```
...
We will cover `ggplot2` and `ggvis` in greater depth in future chapters. Until then, to get started see the chapters on `ggplot2` on [R-Bloggers](http://www.r-bloggers.com/search/ggplot2) and here for [ggvis](http://www.r-bloggers.com/?s=ggvis). Datacamp offers a free tutorial on the use of `ggvis` that can be accessed [here](http://www.r-bloggers.com/ggvis-tutorial-become-a-data-visualization-expert-with-rstudio/). For a wider overview of some of the top R packages see Qin Wenfeng's recent [awesome R list](https://github.com/qinwf/awesome-R).
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/Shiny.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/Radiant.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/manyeyes.png")
```
...
For additional visualization tools and ideas see [visualizing.org](http://www.visualizing.org/) and [Open Data Tools](http://opendata-tools.org/en/visualization/).
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/Gephi.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/NodeXL.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/Pajek.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/VOSviewer.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/Leaflet.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/icharts.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/OpenLayer.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/CartoDB.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/D3.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/highcharts.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/Datawrapper.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/Plotly.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/Jigsaw.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/overview/KHCoder.png")
```
...
NTLK appears to be the leading package and covers almost all major needs. The accompanying book [Natural Language Processing with Python](http://shop.oreilly.com/product/9780596516499.do) may also be worth considering. The [Python Textmining Package](http://www.christianpeccei.com/textmining/) is simpler than the giant NTLK package but may suit your needs. 

```{r echo=FALSE}
knitr::include_graphics("/images/overview/ntlk.png")
```
