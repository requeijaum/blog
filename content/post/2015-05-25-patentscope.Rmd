---
title: Accessing Patent Data with WIPO Patentscope
author: Paul Oldham
date: '2015-05-25'
slug: patentscope-tutorial
categories:
  - Patents
tags: [patentscope, patent databases]
---
```{r opts, echo=FALSE}
...
```{r echo=FALSE}
knitr::include_graphics("/images/patentscope/collections.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/patentscope/simplesearch.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/patentscope/patentscopsesimple_pizza.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/patentscope/query_tree.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/patentscope/pizzaexporting.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/patentscope/results.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/wipo_settings.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/tools/wipo_results.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/patentscope/pizzacrosslingual.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/patentscope/sequencesearching.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/patentscope/pctseq.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/patentscope/sequenceftp.png")
```
